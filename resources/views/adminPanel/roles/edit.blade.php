      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form id="editForm" action="{{ route('adminPanel.roles.update', $roles->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="nameInput" value="{{ old('name', $roles->name) }}">
                            @error('name')
