      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form id="editForm" action="{{ route('adminPanel.shows.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <Select name="type" id="typeInput" class="form-control @error('type') is-invalid @enderror">
                                ...
                                <option value="2" {{old('type') ==  2 ? 'Selected':''}}>TV</option>
                            </Select>
                            @error('type')
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="price" class="form-control @error('price') is-invalid @enderror" id="priceInput" value="{{ old('price') }}">
                            @error('price')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
