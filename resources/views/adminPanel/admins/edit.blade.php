      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form id="editForm" action="{{ route('adminPanel.admins.update', $admin->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="nameInput" value="{{ old('name', $admin->name) }}">
                            @error('name')
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="emailInput" value="{{ old('email', $admin->email) }}">
                            @error('email')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
